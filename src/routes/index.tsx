  ...
  return (
    <>
      <section className="relative isolate min-h-[min(92dvh,820px)] overflow-hidden">
        ...
        />
        <div
          className="absolute inset-0 -z-10 bg-gradient-to-br from-[color-mix(in_oklab,var(--forest-deep)_88%,transparent)] via-[color-mix(in_oklab,var(--forest)_78%,transparent)] to-[color-mix(in_oklab,#1a2e22_55%,transparent)]"
          aria-hidden
        />
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 20%, rgba(184,224,122,0.25), transparent 40%), radial-gradient(circle at 80% 70%, rgba(255,255,255,0.08), transparent 35%)",
          }}
          aria-hidden
        />
        ...
        <div className="page-shell grid gap-8 py-14 md:grid-cols-3">
          {[
            ...
            <div key={item.title} className="animate-fade">
              <div className="mb-3 grid size-10 place-items-center rounded-lg bg-[var(--forest)] text-[var(--leaf)]">
