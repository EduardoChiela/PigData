  ...
  if (compact) {
    return (
      <button
        ...
        className="group flex h-40 w-full gap-3 overflow-hidden rounded-xl border border-border/60 bg-white p-2.5 text-left shadow-sm transition hover:border-stone-300 hover:shadow-md"
      >
        ...
        <div className="min-w-0 flex-1 py-0.5">
          <h3 className="truncate font-display text-[0.95rem] font-semibold tracking-tight">
            {space.name}
          </h3>
          ...
          <AmenityTags
            ...
            limit={1}
            className="mt-2 max-h-6 overflow-hidden"
          />
