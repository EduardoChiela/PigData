...
|------|-----------------|--------|
| T01 Landing | `/bem-vindo` | Implementado |
| T02 Busca/mapa | `/` | Implementado |
| T03 Detalhe | `SpaceDetailPanel` | Implementado |
| T04 Data/evento | `BookingRequestFlow` | Implementado mock |
| T05 Comodidades | `BookingRequestFlow` | Implementado mock |
| T06 Revisao/envio | `BookingRequestFlow` | Implementado mock |
